...
namespace StudyCourseAPI.Migrations
{
    ...
    [Migration("20260601043724_1.0.1")]
    partial class _101
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.CourseSkill", b =>
                {
                    b.Property<long>("CourseId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.Skill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.UserSkill", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.CourseSkill", b =>
                {
                    ...
                    b.HasOne("StudyCourseAPI.Models.Skill", "Skill")
                        .WithMany("CourseSkills")
