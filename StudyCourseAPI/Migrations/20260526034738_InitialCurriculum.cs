        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentTagId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_IsActive_IsDeleted",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_Type_ParentTagId",
                table: "Tags",
                columns: new[] { "Type", "ParentTagId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLessonProgresses_UserId_CourseId",
                table: "UserLessonProgresses",
