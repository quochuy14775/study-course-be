...
namespace StudyCourseAPI.Migrations
{
    ...
    [Migration("20260914075342_Password")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.Article", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.Certificate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.CourseReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.CourseReviewHelpful", b =>
                {
                    ...
                    b.ToTable("CourseReviewHelpfuls");
                });

            modelBuilder.Entity("StudyCourseAPI.Models.CourseReviewReply", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.Quiz", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CourseId", "QuizType");

                    b.ToTable("Quizzes");
                });

            modelBuilder.Entity("StudyCourseAPI.Models.QuizAttempt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.QuizQuestion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.CourseReviewHelpful", b =>
                {
                    b.HasOne("StudyCourseAPI.Models.CourseReview", "Review")
                        .WithMany("Helpfuls")
            ...
            modelBuilder.Entity("StudyCourseAPI.Models.QuizAttempt", b =>
                {
                    b.HasOne("StudyCourseAPI.Models.Quiz", "Quiz")
                        .WithMany("Attempts")
